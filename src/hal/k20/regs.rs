...
ioreg_assign!(k20_iomem_OSC, OSC, Osc);
ioreg_assign!(k20_iomem_MCG, MCG, Mcg);
ioreg_assign!(k20_iomem_SIM, SIM, Sim);
ioreg_assign!(k20_iomem_RTC, RTC, Rtc);
ioreg_assign!(k20_iomem_PMC, PMC, Pmc);
ioreg_assign!(k20_iomem_SMC, SMC, Smc);
ioreg_assign!(k20_iomem_PIT, PIT, Pit);
